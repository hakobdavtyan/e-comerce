                        ...
                        <div class="panel-heading">
                            <div class="btn-group" id="buttonlist">
                                <a class="btn btn-add " href="{{url('admin/view-coupons')}}">
                                    <i class="fa fa-eys"></i>  View Coupons </a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{url('admin/edit-coupons/'.$couponDetails->id)}}" enctype="multipart/form-data" method="post" name="edit_coupon" id="edit_coupon">{{csrf_field()}}
