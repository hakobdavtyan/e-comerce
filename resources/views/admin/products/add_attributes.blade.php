                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{url('/admin/add_attributes/'.$productDetails->id)}}" enctype="multipart/form-data" method="post">{{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <div class="field_wrapper">
                                        <div style="display:flex;">
                                            ...
                                            <a href="javasceipt:void(0);" class="add_button" title="Add Field">Add</a>
                                        </div>
                                    </div>
                                </div>
